...
<div id="content">
    <h2 style="text-align: center; padding: 0 10px 20px 10px">Add new User</h2>
    <div class="container" style="padding: 0 10px 20px 10px">
        <table class="table">
            ...
            <tbody>
            <spring:form method="post" modelAttribute="userJSP" action="add-user" class="form-horizontal">
                <tr>
                    <td>
                        <div class="form-group">
                            <spring:input path="name" class="form-control" id="check2" type="text" placeholder="Name"
                                          name="name"
                                          required="required"/>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <spring:input path="surname" class="form-control" id="check3" type="text"
                    ...
                    <td>
                        <div class="form-group">
                            <spring:input path="login" class="form-control" id="check4" type="text" placeholder="Login"
                                          name="login"
                                          required="required"/>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <spring:input path="password" class="form-control" id="check5" type="password"
