...
<div id="content">
    ...
    <div class="container" style="padding: 0 10px 20px 10px">
        <table class="table">
            ...
            <c:forEach items="${rooms}" var="room">
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="/delete/{roomId}" class="btn btn-danger">DEL</a>
        ...
        <div style="padding: 5px 57px 0 0">
            <a href="/show-add-room" class="btn btn-success pull-right">Add New Room</a>
        </div>
    </div>
</div>

<div id="pagination">
    <c:url value="/admin-rooms" var="prev">
    ...
    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
        <c:choose>
            ...
            <c:otherwise>
                <c:url value="/admin-rooms" var="url">
    ...
    <c:url value="/admin-rooms" var="next">
        <c:param name="page" value="${page + 1}"/>
    </c:url>
